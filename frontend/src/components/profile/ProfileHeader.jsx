        ...
        <div className="-mt-11 flex flex-col gap-5 sm:-mt-10 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex items-end gap-4">
            ...
            <div className="relative shrink-0">
              <div
                className="flex h-20 w-20 items-center justify-center rounded-2xl border-4 border-white bg-slate-100 text-xl font-semibold text-slate-700 shadow-md sm:h-24 sm:w-24"
          ...
          {onEdit && (
            <button
              type="button"
              onClick={onEdit}
              className="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 shadow-sm transition hover:border-slate-300 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-slate-300 focus:ring-offset-2"
            >
              <Pencil size={15} />
